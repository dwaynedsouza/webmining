...
<form name="form1" action="searchs.php">
				<input type ="text" name="s_category" placeholder="JOB CATEGORY">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				JOB EXPERIENCE<select name="s_exp">
...
<br>
<input type ="text" name="s_salary" placeholder="SALARY">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type ="text" name="s_location" placeholder="LOCATION">
